...
**Interactive notebook (`index.ipynb`):**
- Jupyter notebook combining result tables and interactive pydeck maps
- Loads data from `data/output/` (nodes.gpkg, edges.gpkg, results.txt)
- Renders maps inline with legend overlays and north arrow
- Run with `uv run jupyter notebook index.ipynb`
...
- `index.ipynb`: Jupyter notebook with result tables and interactive maps
...
- **jupyter**: Interactive notebook environment for `index.ipynb`
